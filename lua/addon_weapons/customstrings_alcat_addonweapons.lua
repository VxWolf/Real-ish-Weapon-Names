Hooks:Add("LocalizationManagerPostInit", "RishWN_Alcat_AddonGuns", function(loc)
    LocalizationManager:add_localized_strings({
		...
		bm_w_shigu = "Signature Berg 550", --SG 550 that might never be coming || SG 550 is characterized as made for Swiss mountainous range combat
        bm_w_shigu_desc = "The big brother assault rifle of 'Restricted for law enforcement use only'. High damage - Wide part variety.",
