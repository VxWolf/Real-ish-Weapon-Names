Hooks:Add("LocalizationManagerPostInit", "RishWN_AddonGuns", function(loc)
    LocalizationManager:add_localized_strings({
		...
		bm_w_dp28_desc = "Old WWII Russian LMG. Extreme damage - Wide part variety.",
		...
		--Ellie
		bm_w_fyjs = "Chicom FYJS", --included for PLA pack completeness
		bm_w_fyjs_desc = "Presicion Chinese military sniper rifle. Low damage - Balanced performance.",
		...
		bm_w_fortress_desc = "An assault rifle that combines its ammunition with a highly reactive material. High damage - Large magazine.",
